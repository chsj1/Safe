...
import com.njupt.safe.MobileSafeApplication;
import com.njupt.safe.activity.EnterPasswordActivity;
import com.njupt.safe.db.AppLockDao;
import com.njupt.safe.inter.IService;
...
public class AppLockService extends Service {
					...
					if(isLockScreen){
						...
						if(appLocks.contains(packageName)){
							...
							if(!tempAppLocks.contains(packageName)){
								...
								System.out.println("------------>锁屏时的包名是: " + packageName);
	...
	private final class MyContentObserver extends ContentObserver{
		...
		public void onChange(boolean selfChange) {
			...
			System.out.println("MyContentObserver : " + "onChange" );
	...
	private void addTempAppLock(String packageName){
		...
		System.out.println("解锁时----------->addTempAppLock()的包名是: " + packageName);
